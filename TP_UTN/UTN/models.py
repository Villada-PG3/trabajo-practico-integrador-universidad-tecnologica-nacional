...
# Modelos del Diagrama de Entidad-Relación
...
class Materia(models.Model):
    ...
    def __str__(self):
        return f"{self.tipo_materia} ({self.sigla}), Nivel {self.nivel}"
...
# Modelos para las relaciones de Muchos a Muchos
...
class CursoProfesor(models.Model):
    id_curso_profesor = models.AutoField(primary_key=True)
...
class CondicionFinal(models.Model):
    ...
    profesor = models.ForeignKey(Profesor, on_delete=models.CASCADE, related_name='condiciones_evaluadas')
